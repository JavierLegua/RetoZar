...
<body>
    <h1>Introduce los nuevos datos del administrador</h1>
        <form action="ActualizarAdmin.php" method="post">
            ...
            <input type="text" name="Rol" id="Rol" placeholder="Admin" onblur="this.value = 'Admin'" required>
            <input id="crear" type="submit" value="Editar" name="Editar" onclick="redirigir_alumnos(EditarAdmin.php,<?php $dni?>)">
    </form>
</body>
</html>