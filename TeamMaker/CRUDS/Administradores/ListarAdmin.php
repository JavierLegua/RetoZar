    ...
    <table class="table" id="tableAdmin">
      ...
      <?php
        for ($i=0; $i < count($admins); $i++) { 
          ...
          $_SESSION['dni']=$dni;
          echo "<tr>
              <td>".$admins[$i]->DNI."</td><td>".$admins[$i]->nombre."</td><td><input class=\"buttonList\" type=\"image\" src=\"../../Estilos/Editar.png\" value=\"x\" name=\"Volver\" onclick=\"redirigir_alumnos('editarAdmin','".$dni."')\"></td><td><input class=\"buttonList\" type=\"image\" src=\"../../Estilos/Eliminar.png\" value=\"X\" name=\"Volver\" onclick=\"redirigir_alumnos('borrarAdmin','".$dni."')\"></td></tr>";
        }
      ?>
      </tbody>
    </table>
